...
export default async function LoginPage() {
  ...
  return (
    <section className="mx-auto max-w-[520px] px-4 py-12 max-[680px]:flex max-[680px]:min-h-[calc(100vh-7rem)] max-[680px]:items-center max-[680px]:py-0">
      <div className="card w-full border border-line bg-base-100 shadow-[0_18px_45px_rgba(31,35,40,0.08)]">
        <div className="card-body px-[clamp(1.5rem,5vw,4rem)] py-10 max-[680px]:p-6 max-[680px]:text-[0.9rem]">
          <h1 className="card-title mb-1.5 text-2xl max-[680px]:text-[1.35rem]">Log in</h1>
          ...
          <p className="muted mt-6 text-center max-[680px]:text-[0.82rem]">
            New here?{" "}
            <Link href="/signup" className="link link-hover font-bold text-good">
              Create an account
            </Link>
          </p>
        </div>
